...
export default {
  ...
  mounted() {
    ...
    this.dropzone = new Dropzone(element, {
      ...
      sending: (file, xhr, formData) => {
        ...
        vm.$emit('dropzone-sending', file, xhr, formData)
      }
    })

    // if (this.couldPaste) {
    //   document.addEventListener('paste', this.pasteImg)
    //   console.log('cloudpause')
    // }
  ...
  methods: {
    ...
    resetparallelUploads(num) {
      this.dropzone.options.parallelUploads = num
      console.log('一次上传数量:', num)
    }

<template>
  <div class="grid-content">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="经销范围" prop="agencyarea_code">
              <PositionSelector v-model="userdealer.agencyarea_code" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="法人代表" prop="legalperson">
              <el-input v-model="userdealer.legalperson" class="input" size="mini" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="公司名称" prop="companyname">
              <el-input v-model="userdealer.companyname" class="input" size="mini" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="联系人" prop="legalperson">
              <el-input v-model="userdealer.dealername" class="input" size="mini" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="联系方式" prop="legalperson">
              <el-input v-model="userdealer.telphone" class="input" size="mini" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
            ...
            <el-form-item label="公司地址" prop="companyaddress_areacode">
              <el-row>
                <el-col class="selectorgroup">
                  <PositionSelector v-model="userdealer.companyaddress_areacode" />
                </el-col>
                <el-col :span="6">
                  <el-input v-model="userdealer.companyaddressdetail" class="input" size="mini" placeholder="详细地址" />
                </el-col>
              </el-row>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="纳税人识别号" prop="taxcode">
              <el-input v-model="userdealer.taxcode" class="input" size="mini" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开户行全称" prop="bankname">
              <el-input v-model="userdealer.bankname" class="input" size="mini" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开户行账号" prop="bankaccount">
              <el-input v-model="userdealer.bankaccount" class="input" size="mini" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="开户行地址" prop="bankaddr">
              <el-input v-model="userdealer.bankaddr" class="input" size="mini" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="电话" prop="companytel">
              <el-input v-model="userdealer.companytel" class="input" size="mini" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item>
    ...
    <UserAgreement v-if="showagreement" @accept="accept" @refuse="refuse" />
  </div>
</template>

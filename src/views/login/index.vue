  ...
  <div class="login-container">
    ...
    >
      ...
      <div style="float:left;">
        ...
        <span
          style="color:gray;font-size: 10px;line-height: 19px;margin:0px 10px;text-indent: 2px;"
        >不是自己电脑不要勾选此项</span>
      </div>
    ...
    <div class="footer_content_copyright">
      Copyright©2012-2022 重庆物鲸数字科技有限公司版权所有
      <a
        href="https://beian.miit.gov.cn/#/Integrated/index"
        rel="nofollow"
        target="_blank"
      >备案号： 渝ICP备19011486号-1</a>
    </div>
  </div>
</template>

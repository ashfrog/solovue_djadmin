  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="telphone">
        <el-input ref="telphone" v-model="loginForm.telphone" placeholder="请输入手机号" name="telphone" type="text" tabindex="1"
          auto-complete="on" />
      </el-form-item>
      ...
      <el-form-item prop="password">
        <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="输入6-18位数字或字母为密码"
